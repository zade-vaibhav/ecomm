...
const register_mail = async (email, name, otp) => {
  ...
  const transporter = nodemailer.createTransport({
    // host: 'corazor.com',
    // port: 995, // Use the appropriate port for your configuration
    // secure: false, // Set to true if using SSL/TLS, false if using STARTTLS or no encryption
    service: 'gmail',
    auth: {
    ...
    html: `<div style="font-family: Helvetica,Arial,sans-serif;min-width:1000px;overflow:auto;line-height:2">
        <div style="margin:50px auto;width:70%;padding:20px 0">
          <div style="border-bottom:1px solid #eee">
            <a href="" style="font-size:1.4em;color: #00466a;text-decoration:none;font-weight:600">OurStore</a>
          </div>
          <p style="font-size:1.1em">Hi, ${name}</p>
          <p>Thank you for choosing OurStore. Use the following OTP to complete your Sign Up procedures. OTP is valid for 2 minutes</p>
          <h2 style="background: #00466a;margin: 0 auto;width: max-content;padding: 0 10px;color: #fff;border-radius: 4px;">${otp}</h2>
          <p style="font-size:0.9em;">Regards,<br />OurStore</p>
  ...
  const mailOption = {
    ...
    html: ` <div style="font-family: Helvetica,Arial,sans-serif;min-width:1000px;overflow:auto;line-height:2">
        <div style="margin:50px auto;width:70%;padding:20px 0">
          ...
          <p style="font-size:1.1em">Hi, ${name}</p>
          <p>This is your one-time OTP to Reset-Password by OurStore. OTP is valid for 2 minutes</p>
          <h2 style="background: #00466a;margin: 0 auto;width: max-content;padding: 0 10px;color: #fff;border-radius: 4px;">${otp}</h2>
          <p style="font-size:0.9em;">Regards,<br />OurStore</p>
          <hr style="border:none;border-top:1px solid #eee" />
          <div style="float:right;padding:8px 0;color:#aaa;font-size:0.8em;line-height:1;font-weight:300">
...
const register_greet = async (name, email) => {
  ...
  const mailOption = {
    ...
    html: `<body style="font-family: Helvetica, Arial, sans-serif; min-width: 1000px; overflow: auto; line-height: 2; margin: 0; padding: 0;">
        ...
        <div style="margin: 50px auto; width: 70%; padding: 20px 0;">
          <p style="font-size: 1.1em;">Hi, ${name},</p>
          <p>Congratulations! Your registration with OurStore was successful.</p>
          <p>You are now a part of our community. Enjoy exploring!</p>
          <p style="font-size: 0.9em;">Regards,<br />OurStore Team</p>
        </div>
...
const verify_greet = async (name, email) => {
  ...
  const mailOption = {
    ...
    html: `<body style="font-family: Helvetica, Arial, sans-serif; min-width: 1000px; overflow: auto; line-height: 2; margin: 0; padding: 0;">
        ...
        <div style="margin: 50px auto; width: 70%; padding: 20px 0;">
          <p style="font-size: 1.1em;">Hi, ${name},</p>
          <p>Congratulations! Your email has been successfully verified with OurStore.</p>
  ...
  const mailOption = {
    ...
    html: `<div style="font-family: Helvetica, Arial, sans-serif; min-width: 1000px; overflow: auto; line-height: 2">
        <div style="margin: 50px auto; width: 70%; padding: 20px 0">
          ...
          <p style="font-size: 1.1em">Hi, ${name}</p>
          <p>Your OurStore account password has been successfully updated. If you didn't make this change, please contact us immediately.</p>
